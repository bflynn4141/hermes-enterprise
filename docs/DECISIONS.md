...
| [Runtime and team workflow decisions](decisions/08-runtime-and-team-workflows.md) | Current runtime, recovery, observability, team workflow, and managed-capacity decisions C48 through C91. |
