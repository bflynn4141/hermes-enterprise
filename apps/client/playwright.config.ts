...
export default defineConfig({
  ...
  testIgnore: process.env.E2E_BASE_URL
    ...
    : ['**/live.spec.ts', '**/live-screens.spec.ts', '**/live-findings.spec.ts', '**/live-m5a.spec.ts', '**/live-panel.spec.ts', '**/live-openrouter.spec.ts', '**/live-transcript.spec.ts', '**/live-chat-screens.spec.ts'],
